...
/* (amd64) X86-64 on linux defines the width of a long double to be 128 bits
   but it is still only 80 bits wide with padding at the end. */
static union {
 long double d;
 unsigned short s[8];
} unkans;
